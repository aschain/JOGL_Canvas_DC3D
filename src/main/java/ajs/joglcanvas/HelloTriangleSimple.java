...
public class HelloTriangleSimple implements GLEventListener, KeyListener {
    ...
    private ByteBuffer globalMatricesPointer, modelMatrixPointer, vbuffer;
    ...
    private void initBuffers(GL4 gl) {
        ...
        gl.glBufferStorage(GL_ARRAY_BUFFER, vertexData.length * Float.BYTES*16, null, GL_MAP_WRITE_BIT | GL_MAP_PERSISTENT_BIT | GL_MAP_COHERENT_BIT);
        ...
        vbuffer = gl.glMapNamedBufferRange(
                bufferName.get(Buffer.VERTEX),
                0,
                vertexData.length * Float.BYTES*16,
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        vbuffer.asFloatBuffer().put(vertexData);
    ...
    abstract static private class Semantic{
